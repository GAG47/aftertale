...
func generate_location(source_data: Dictionary, context: Dictionary = {}) -> Dictionary:
	...
	_generated = {
		...
		"roofs": [],
		"entrances": [
			{ "id": "entry", "grid_position": { "x": 5, "y": 6 }, "facing": "up" },
		],
		"anchors": [
			{ "id": "entry", "kind": "entry", "grid_position": { "x": 5, "y": 6 }, "facing": "up" },
			{ "id": "exit", "kind": "exit", "grid_position": { "x": 5, "y": 6 }, "facing": "down" },
